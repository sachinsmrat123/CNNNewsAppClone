...
public abstract class Hilt_TopNewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TopNewsFragment() {
    super();
  }

  Hilt_TopNewsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TopNewsFragment_GeneratedInjector) this.generatedComponent()).injectTopNewsFragment(UnsafeCasts.<TopNewsFragment>unsafeCast(this));
    }
  }
